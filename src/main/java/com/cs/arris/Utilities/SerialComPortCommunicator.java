...
public class SerialComPortCommunicator {
	public static void main(String[] args) {
		try {
			...
			scm.findDriverServingComPort("/dev/tty.usbserial-142310");
			System.out.println(scm.getPortName(handle));
	//		scm.writeString(handle, "dmcli eRT setv Device.X_ARRIS_COM_General.DeviceReset.ResetMode string FACTORY_RESET", 85);
			try {
