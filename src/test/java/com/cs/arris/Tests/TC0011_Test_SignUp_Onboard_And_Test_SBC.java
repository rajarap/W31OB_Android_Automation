...
//			}
		  ...
		  @Test(priority = 80, dependsOnMethods = {"Verify_SignUp_And_Onboard" })
...
//					softcontrol3.assertTrue(new ParentalControlWithProfilesPage().verifyUserProfile());
			...
			@Test(priority = 82, dependsOnMethods = {"Verify_SignUp_And_Onboard" , "Verify_Parental_Control_UI_Page"})
...
//						softcontrol4.assertTrue(new ParentalControlWithProfilesPage().getUserProfilePageObject().verifyUIOnUserProfilePage());
			...
			@Test(priority = 85, dependsOnMethods = {"Verify_SignUp_And_Onboard" , "Verify_User_Profile_Page"})
...
//					softcontrol11.assertTrue(new ParentalControlWithProfilesPage().getUserProfilePageObject().getParentalUserProfileAddRulePageObject().getInternetBlockingScheduleDialogObject().verifyUIOnAddInternetBlockingScheduleDialog());
		...
		//			softcontrol14.assertTrue(new ParentalControlWithProfilesPage().getUserProfilePageObject().getParentalUserProfileAddRulePageObject().getInternetBlockingScheduleDialogObject().verifyUIOnCustomClick());
			...
			@Test(priority = 95, dependsOnMethods = {"Verify_SignUp_And_Onboard" , "Verify_User_Profile_Page"})
...
//			
//			@Test(priority = 96, dependsOnMethods = {"Verify_SignUp_And_Onboard"})
...
//			}
			...
			@Test(priority = 97, dependsOnMethods = {"Verify_SignUp_And_Onboard" , "Verify_User_Profile_Page"})
...
//			}
			...
			@Test(priority = 111, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_WAN_Settings_UI_Page"})
			...
			@Test(priority = 112, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_WAN_Settings_UI_Page"})
			...
			@Test(priority = 113, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_WAN_Settings_UI_Page"})
			...
			@Test(priority = 118, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_WAN_Settings_UI_Page"})
...
//						utils.log().info("App Rating Dialog did not appear");
		...
		//			softnet18.assertTrue(new NetworkPage().getLANSettingsPageObject().verifyUIOnLANSettingsPage());
			...
			@Test(priority = 120, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_LAN_Settings_UI_Page"})
			...
			@Test(priority = 122, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_LAN_Settings_LAN_IP_Reservation_Add_Reservation_Page"})
...
//				softnet21.assertTrue(new NetworkPage().getLANSettingsPageObject().getNetworkLANIPReservationPageObject().verifyRulesOnLAPIPReservationPage());
			...
			@Test(priority = 123, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_LAN_Settings_LAN_IP_Reservation_Rules"})
...
//					softnet22.assertTrue(new NetworkPage().getLANSettingsPageObject().getNetworkLANIPReservationPageObject().getEditLANIPReservationDialogObject().verifyUIOnEditReserveLANIP());
			...
			@Test(priority = 124, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_LAN_Settings_LAN_IP_Reservation_Page"})
...
//				}
			...
			@Test(priority = 125, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_LAN_Settings_UI_Page"})
			...
			@Test(priority = 126, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_LAN_Settings_LAN_Subnet_DHCP_Range_Configuration_Page"})
			...
			@Test(priority = 127, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_LAN_Settings_LAN_Subnet_DHCP_Range_Configuration_Page"})
			...
			@Test(priority = 128, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_LAN_Settings_LAN_Subnet_DHCP_Range_Configuration_Page"})
...
//				}
			...
			@Test(priority = 129, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_LAN_Settings_UI_Page"})
...
//				//remove this if above test are uncommented
		...
		//				softnet28.assertTrue(new NetworkPage().getLANSettingsPageObject().getNetworkLANDHCPLeaseTimePageObject().verifyUIOnLANLeaseTimePage());
			...
			@Test(priority = 130, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_LAN_Settings_LAN_DHCP_Lease_Time_UI_Page"})
			...
			@Test(priority = 131, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_LAN_Settings_LAN_DHCP_Lease_Time_UI_Page"})
...
//					softnet30.assertTrue(new NetworkPage().getLANSettingsPageObject().getNetworkLANDHCPLeaseTimePageObject().getLANDHCPLeaseTimeHelpPageObject().clickCloseButton());
			...
			@Test(priority = 132, dependsOnMethods = {"Verify_SignUp_And_Onboard"})
...
//			@Test(priority = 133, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_Device_Priority_Settings_UI_Page"})
...
//			@Test(priority = 135, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_Device_Priority_Settings_Add_Device_Page"})
...
//			@Test(priority = 138, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_Device_Priority_Settings_UI_Page"})
...
//			}
			...
			@Test(priority = 139, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_Network_UI_Page"})
...
//			@Test(priority = 140, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_Time_Zone_Settings_UI_Page"})
...
//			}
			...
			@Test(priority = 141, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_Network_UI_Page"})
			...
			@Test(priority = 142, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_General_Settings_UI_Page"})
			...
			@Test(priority = 143, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_General_Settings_UI_Page"})
			...
			@Test(priority = 144, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_General_Settings_UI_Page"})
			...
			@Test(priority = 145, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_General_Settings_UI_Page"})
...
//			@Test(priority = 147, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_General_Settings_Port_Forwarding_Settings"})
	//
...
//			}
	//
//			@Test(priority = 148, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_General_Settings_Port_Forwarding_Settings"})
...
//			}
			...
			@Test(priority = 149, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_General_Settings_Port_Forwarding_Settings"})
...
//					softnet48.assertTrue(new NetworkPage().getGeneralSettingsPageObject().getNetworkGeneralSettingsPortForwardingPageObject().getPortForwardingHelpPageObject().clickCloseButton());
			...
			@Test(priority = 150, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_Network_UI_Page"})
			...
			@Test(priority = 151, dependsOnMethods = {"Verify_SignUp_And_Onboard", "Verify_Network_UI_Page"})
...
//						softnet49.assertTrue(new NetworkPage().getEnableGuestNetworkDialogObject().verifyUIOnGuestNetworkPage());
			...
			@Test(priority = 152, dependsOnMethods = { "Verify_SignUp_And_Onboard" })
			...
			@Test(priority = 164, dependsOnMethods = { "Verify_Network_Health_Page" })
			...
			@Test(priority = 165, dependsOnMethods = { "Verify_Network_Health_Page" })
...
//			@Test(priority = 166, dependsOnMethods = { "Verify_Network_Health_Page" })
...
//			}
			...
			@Test(priority = 167, dependsOnMethods = { "Verify_Network_Health_Page" })
...
//				softnetwork16.assertTrue(new HomePage().getNetworkOtptimizationPageObject().clickBackButton());
			...
			public void Verify_Install_Left_Satellite() {
				...
				utils.log().info("Manually switch on your Satellite and perform bluetooth pairing");
				super.pause(60);
	...
	//			new HomePage().getFooterIconsPageObject().clickHomeButton();
			...
			public void Verify_Install_Right_Satellite() {
				...
				utils.log().info("Manually switch on your Satellite2 and perform bluetooth pairing");
				super.pause(60);
